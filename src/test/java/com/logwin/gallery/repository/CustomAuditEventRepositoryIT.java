package com.logwin.gallery.repository;

import com.logwin.gallery.GalleryApp;
import com.logwin.gallery.config.Constants;
import com.logwin.gallery.config.audit.AuditEventConverter;
import com.logwin.gallery.domain.PersistentAuditEvent;
...
import static com.logwin.gallery.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
